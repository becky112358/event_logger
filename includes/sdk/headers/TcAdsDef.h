...
#pragma once
...
#if !defined(POSIX) || defined(HAS_WINTYPES)
	typedef CHAR				ads_i8;
	typedef BYTE				ads_ui8;
	typedef USHORT				ads_ui16;
	typedef LONG				ads_i32;
	typedef ULONG				ads_ui32;
	typedef BOOL				ads_bool;
	...
	typedef unsigned int		ads_bool;
	typedef int64_t			ads_i64;
#endif

#ifndef POSIX
	#ifndef TCADSDLL_EXPORT
	#define TCADSDLL_EXPORT	__declspec( dllexport )
	#endif
	#ifndef TCADSDLL_API
...
////////////////////////////////////////////////////////////////////////////////
typedef void (TCADSDLL_API *PAdsNotificationFuncEx)(	AmsAddr*	pAddr,
...
typedef void (*PAmsRouterNotificationFunc)( ads_i32 nEvent );
